...
public class DatabaseManager {
    // XAMPP MySQL defaults: host=localhost, port=3306, user=root, password=""
    private static final String HOST     = "localhost";
    private static final String PORT     = "3306";
    private static final String DB_NAME  = "electric_billing_db";
    private static final String USER     = "root";
    private static final String PASSWORD = ""; // XAMPP default: empty password

    // Base URL without database — used to CREATE the database if it doesn't exist
    ...
    public boolean testConnection() {
        ...
        // Step 1: connect without specifying the database to create it if missing
        try (Connection conn = DriverManager.getConnection(BASE_URL, USER, PASSWORD);
            ...
            logger.severe("Cannot connect to MySQL server: " + e.getMessage());
            return false;
        }
        // Step 2: verify full connection with the database
    ...
    public void runMigrations() {
        try (Connection conn = getConnection(); Statement st = conn.createStatement()) {
            ...
            // 14. Customer notifications table
            st.executeUpdate(
