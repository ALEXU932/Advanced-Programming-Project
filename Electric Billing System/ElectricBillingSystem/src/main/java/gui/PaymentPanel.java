...
public class PaymentPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        exportBtn.addActionListener(e -> utils.ExcelExporter.export(this, table, "Payments"));
    }
        ...
        try (Connection conn = DatabaseManager.getInstance().getConnection();
            ...
            if (rs.next()) {
                ...
                if (email != null && !email.isEmpty()) {
                    utils.EmailService.sendPaymentConfirmation(
        ...
        confirmBtn.addActionListener(e -> {
            ...
            try (Connection conn = DatabaseManager.getInstance().getConnection()) {
                ...
                if (au != null) utils.AuditLogger.log(au.getUserId(), au.getUsername(),
                    utils.AuditLogger.Action.RECORD_PAYMENT,
