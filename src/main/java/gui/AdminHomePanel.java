...
/**
 * AdminHomePanel represents the main dashboard panel for administrators in the
 * Electric Billing System.
 * It displays key performance indicators (KPIs), charts, recent bills,
 * anomalies, and quick action buttons.
 * The panel includes real-time data updates, export functionality, and
...
public class AdminHomePanel extends JPanel {
    ...
    /**
     * Builds the main UI components of the dashboard including top bar, KPIs,
     * charts, and tables.
     */
        ...
        right.add(new JSeparator(SwingConstants.VERTICAL) {
            {
                ...
                setForeground(new Color(60, 80, 120));
            }
        });
        right.add(timeLabel);
        right.add(exportBtn);
    ...
    private JPanel buildRecentBillsCard() {
        ...
        table.getColumnModel().getColumn(3).setCellRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(
                ...
                setForeground(
                        "PAID".equals(s) ? UITheme.SUCCESS : "OVERDUE".equals(s) ? UITheme.DANGER : UITheme.WARNING);
    ...
    private JPanel buildRecentAnomaliesCard() {
        ...
        table.getColumnModel().getColumn(2).setCellRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(
                ...
                String s = v != null ? v.toString() : "";
                setForeground(
                        "HIGH".equals(s) ? UITheme.DANGER : "MEDIUM".equals(s) ? UITheme.WARNING : UITheme.ACCENT);
                setBackground(sel ? UITheme.PRIMARY : UITheme.TABLE_ROW1);
                return this;
            }
        });
        ...
        JLabel emptyLbl = new JLabel(
                "<html><center>No anomalies detected this month<br><font color='#32C864'>System is healthy</font></center></html>",
    ...
    /**
     * Loads all dashboard data asynchronously including KPIs, chart data, and
     * recent records.
     */
