...
/**
 * AIAnalyticsPanel displays prediction and anomaly analytics for customers.
 * It integrates the consumption predictor and anomaly detector with a chart
 * and table UI for interaction.
 */
