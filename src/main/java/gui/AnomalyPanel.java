...
/**
 * AnomalyPanel shows detected usage anomalies and provides controls for
 * scanning, resolving, and managing anomaly records.
 */
public class AnomalyPanel extends JPanel {
    ...
    private void markResolved() {
        ...
        try (Connection conn = DatabaseManager.getInstance().getConnection();
            ...
            if (au != null) Logic.AuditLogger.log(au.getUserId(), au.getUsername(),
                Logic.AuditLogger.Action.RESOLVE_ANOMALY,
    ...
    private void deleteSelected() {
        ...
        try (Connection conn = DatabaseManager.getInstance().getConnection();
            ...
            User au = Logic.SessionManager.getCurrentUser();
            if (au != null) Logic.AuditLogger.log(au.getUserId(), au.getUsername(),
                Logic.AuditLogger.Action.DELETE_ANOMALY,
