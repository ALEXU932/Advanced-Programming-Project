...
public class BillingPanel extends JPanel {
    ...
    private void buildUI() {
        ...
        excelBtn.addActionListener(e -> report.ExcelExporter.export(this, table, "Bills"));
    ...
    private void generateBill(int customerId, int tariffId, String month) {
        ...
        try (Connection conn = DatabaseManager.getInstance().getConnection();
            ...
            if (au != null) Logic.AuditLogger.log(au.getUserId(), au.getUsername(),
                Logic.AuditLogger.Action.GENERATE_BILL,
    ...
    private void markSelectedPaid() {
        ...
        try (Connection conn = DatabaseManager.getInstance().getConnection();
            ...
            User au = Logic.SessionManager.getCurrentUser();
            if (au != null) Logic.AuditLogger.log(au.getUserId(), au.getUsername(),
                Logic.AuditLogger.Action.MARK_BILL_PAID,
            ...
            if (rs.next()) {
                ...
                if (fc.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
                    ...
                    if (PDFGenerator.generatePDF(bill, customer, tariff, path, picPath)) {
                        User au = Logic.SessionManager.getCurrentUser();
                        if (au != null) Logic.AuditLogger.log(au.getUserId(), au.getUsername(),
                            Logic.AuditLogger.Action.EXPORT_BILL,
        ...
        try (Connection conn = DatabaseManager.getInstance().getConnection();
            ...
            if (rs.next()) {
                ...
                if (email != null && !email.isEmpty()) {
                    report.EmailService.sendBillGenerated(
