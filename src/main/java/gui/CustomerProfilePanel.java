    ...
    private JPanel buildAvatarCard() {
        ...
        uploadBtn.addActionListener(e -> {
            ...
            if (savePicPath(path)) {
                ...
                Logic.AuditLogger.log(user.getUserId(), user.getUsername(),
                    Logic.AuditLogger.Action.UPLOAD_PHOTO, "Customer uploaded profile picture");
            } else {
    ...
    private JPanel buildProfileCard() {
        ...
        saveBtn.addActionListener(e -> {
            ...
            try (Connection conn = DatabaseManager.getInstance().getConnection();
                ...
                Logic.AuditLogger.log(user.getUserId(), user.getUsername(),
                    Logic.AuditLogger.Action.UPDATE_PROFILE,
        ...
        changeBtn.addActionListener(e -> {
            ...
            try (Connection conn = DatabaseManager.getInstance().getConnection()) {
                ...
                if (rs.next() && PasswordUtils.verify(curr, rs.getString(1))) {
                    ...
                    Logic.AuditLogger.log(user.getUserId(), user.getUsername(),
                        Logic.AuditLogger.Action.CHANGE_PASSWORD, "Customer changed password");
