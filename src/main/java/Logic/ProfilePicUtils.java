...
import java.io.IOException;
 ...
 /**
 * Utility class for handling user profile picture uploads and management.
 * Supports image resizing, cropping, and file operations.
 */
public class ProfilePicUtils {
    ...
    /**
     * Opens a file chooser dialog to select and save a profile picture.
     * Resizes the image to 256x256 and saves as PNG.
     * @param parent the parent component for the dialog
     * @param userId the user ID for naming the file
     * @return the path to the saved image, or null if failed
     */
     ...
     * Crops from the center and uses bicubic interpolation.
     * @param src the source image
     * @param size the target size in pixels
     * @return the resized square image
     */
    ...
    /**
     * Deletes the profile picture file for a user.
     * @param userId the user ID whose picture to delete
     */
    ...
    /**
     * Renames a temporary profile picture to the permanent user file.
     * @param tempId the temporary user ID
     * @param realId the real user ID
